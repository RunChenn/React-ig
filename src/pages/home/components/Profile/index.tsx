...
const Profile: React.FC = () => {
  ...
  return (
    <div className="mt-8 ml-8 shadow-lg box-border p-2">
      <User account="bruce_fe" location="布魯斯前端" avatar="/images/avatar.png" size="medium" />
      ...
      {friends.map((item) => {
        ...
        return (
          <div className="-mt-3" key={id}>
            <User id={id} account={account} avatar={avatar} location={location} isFollowing={isFollowing} showFollow />
          </div>
        );
      })}
    </div>
